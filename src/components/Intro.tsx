...
const PLAY_MS = 3200; // glow buildup + settle
const FADE_MS = 900; // overlay fade-out
...
export default function Intro({ title, subtitle }: Props) {
  ...
  return (
    ...
    >
      <h1 className="intro-title font-display text-5xl font-bold leading-[1.05] tracking-tight md:text-7xl lg:text-8xl">
        {title}
        {subtitle && (
